...
exports.createTrackingRecord = createTrackingRecord;
 ...
 */
async function createTrackingRecord(dto) {
 ...
 */
async function updateTrackingStatus(notificationId, status, metadata) {
    const prisma = (0, prisma_1.getPrismaClient)();
