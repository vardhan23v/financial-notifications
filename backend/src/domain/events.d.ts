...
export type EventPayload = MarginCallEvent | TradeConfirmationEvent | OrderStatusEvent | PriceAlertEvent | PortfolioUpdateEvent | DividendCreditEvent | CorporateActionEvent | PaymentConfirmationEvent | LargeTransactionAlertEvent | UpiCollectRequestEvent | KycUpdateEvent | KycExpiryReminderEvent | AccountClosureEvent | PolicyRenewalEvent | ClaimStatusEvent | PremiumDueEvent | EmiReminderEvent | LoanDisbursementEvent | CreditScoreUpdateEvent | SipDebitEvent | NavUpdateEvent | LoginAlertEvent | PasswordChangeEvent | SuspiciousActivityEvent | RegulatoryUpdateEvent | TaxStatementEvent;
